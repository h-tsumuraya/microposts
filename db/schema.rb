...
ActiveRecord::Schema.define(version: 20160328032233) do
  ...
  add_index "retweets", ["user_id", "micropost_id"], name: "index_retweets_on_user_id_and_micropost_id", unique: true
